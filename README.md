...
- **Recipe Display:** ძირითად გვერდი, რომელზეც ასახულია რეცეპტების სია, თითო თავისი სახელით, აღწერითა და სურათით.

- **Recipe Details:** გაჩვენებს რეცეპტის ყველა დეტალს, მათ შორის ინრედიენტებსა და ინსტრუქციებს.
- **Adding Recipes:** ახალი რეცეპტის დამატება. ამისთვის უნდა მივუთითოთ სახელი, აღწერა, ინგრედიენტები, ინსტრუქცია და გამოსახულება.
- **Editing & Deleting:** შეგიძლია რეცეპტის განახლება ან წაშლა.
- **Search Functionality:** რეცეპტების გაფილტრვა სახელის, ინგრედიენტების, ან **"რჩეულების"** მიხედვით.
- **Routing:** ნავიგაცია Angular Router-ის გამოყენებით.
- **Favorites:** შეგიძლია რეცეპტების **"რჩეულად"** მონიშვნა და მათი გაფილტრვა. -->
